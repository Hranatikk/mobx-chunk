...
* **Queries & Mutations**: Built-in data fetching with per-argument caching, loading/error tracking, infinite pagination, and manual invalidation — similar to TanStack Query but powered by MobX observables.
* **React Integration**: Use provided hooks (`useValues`, `useComputed`, `useChunk`, `useQuery`, `useInfiniteQuery`, `useMutation`) for seamless, observable-driven updates in your components.

## Getting Started

### What you’ll need

* **React** (v17, v18, or v19) or **React Native**
* **MobX** (v6 or above)
